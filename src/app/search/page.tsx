...
import { stylists } from '@/lib/data'; // モックデータをインポート
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div>
            ...
            <select id="area" name="area" className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm rounded-md">
              <option>指定なし</option>
              <option>東京</option>
              <option>大阪</option>
              <option>福岡</option>
          ...
          <div>
            ...
            <select id="style" name="style" className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm rounded-md">
              <option>指定なし</option>
              <option>ショート</option>
              <option>ミディアム</option>
              <option>ロング</option>
          ...
          <div>
            ...
            <select id="price" name="price" className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm rounded-md">
              <option>指定なし</option>
              <option>〜¥8,000</option>
              <option>¥8,001〜¥12,000</option>
              <option>¥12,001〜</option>
            </select>
          </div>
        </div>
